...
public class SearchWindow extends JFrame implements KeyListener{
	protected static final int WINDOW_SIZE = 320;
	protected static final int SEARCH_NUM = 4;
	MainPanel MP;
	private boolean isStart;
	SearchWindow(String title, Status initial)
	{
		isStart = false;
		setTitle(title);
